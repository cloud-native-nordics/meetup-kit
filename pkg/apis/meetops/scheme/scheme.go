...
import (
	...
	"github.com/cloud-native-nordics/meetup-kit/pkg/apis/meetops"
	"github.com/cloud-native-nordics/meetup-kit/pkg/apis/meetops/v1alpha1"
...
func AddToScheme(scheme *runtime.Scheme) {
	...
	utilruntime.Must(meetops.AddToScheme(Scheme))
